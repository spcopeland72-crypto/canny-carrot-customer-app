/**
 * Sustain homescreen – structure cloned from canny-carrot-sustain (Olio-style UI).
 * Header, filter bar, get started carousel, section carousels, ad banner, action grid.
 * Canny Carrot branding can be applied after.
 */
...
const SustainScreen: React.FC<SustainScreenProps> = ({
  currentScreen = 'Sustain',
  onNavigate,
  onBack,
  onScanPress,
}) => {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        <View style={styles.headerRow}>
          <View>
            <Text style={styles.headerHint}>Listings within 3.1mi</Text>
            <TouchableOpacity style={styles.locationPill} activeOpacity={0.7}>
              <Text style={styles.locationText}>Wynyard Avenue</Text>
      ...
      <ScrollView
        ...
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>Free food</Text>
        ...
        {/* Reduced food */}
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>Reduced food</Text>
          <TouchableOpacity><Text style={styles.seeAll}>All &gt;</Text></TouchableOpacity>
        </View>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.carouselContent}>
          {[
        ...
        {/* Non-food */}
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>Non-food</Text>
          <TouchableOpacity><Text style={styles.seeAll}>All &gt;</Text></TouchableOpacity>
        </View>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.carouselContent}>
          {[
        ...
        {/* Lucky Dip bags */}
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>Lucky Dip bags</Text>
          <TouchableOpacity><Text style={styles.seeAll}>All &gt;</Text></TouchableOpacity>
        </View>
        ...
        {/* Going soon */}
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>Going soon</Text>
          <TouchableOpacity><Text style={styles.seeAll}>All &gt;</Text></TouchableOpacity>
        </View>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.carouselContent}>
          {[
        ...
        {/* Help a neighbour */}
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>Help a neighbour</Text>
          <TouchableOpacity><Text style={styles.seeAll}>All &gt;</Text></TouchableOpacity>
        </View>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.carouselContent}>
          {[
        ...
        {/* Just gone */}
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>Just gone</Text>
          <TouchableOpacity><Text style={styles.seeAll}>All &gt;</Text></TouchableOpacity>
        </View>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.carouselContent}>
          {[
        ...
        {/* Refurbished tech */}
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>Refurbished tech</Text>
          <TouchableOpacity><Text style={styles.seeAll}>All &gt;</Text></TouchableOpacity>
        </View>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.carouselContent}>
          {[
...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: Colors.background, borderBottomWidth: 1, borderBottomColor: Colors.neutral[200] },
  headerRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 12 },
  headerHint: { fontSize: 12, color: Colors.text.secondary },
  locationPill: { flexDirection: 'row', alignItems: 'center', alignSelf: 'flex-start', marginTop: 4, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 999, backgroundColor: '#E9D5FF' },
  locationText: { fontSize: 14, fontWeight: '600', color: '#6B21A8' },
  locationChevron: { fontSize: 10, color: '#6B21A8', marginLeft: 4 },
  headerIcons: { flexDirection: 'row', gap: 12 },
  iconBtn: { padding: 8 },
  iconSymbol: { fontSize: 20 },
